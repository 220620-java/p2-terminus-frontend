 ...
 * 
 * @param {*} level - Message priority level (ALERT, INFO, SUCCESS)
 * @param {*} message  - The message passed to the message box
 */
function message(level, message) {
    ...
    setTimeout(function() {
        ...
        document.getElementById(level).webkitAnimationPlayState = "paused"
    }, 3000);
