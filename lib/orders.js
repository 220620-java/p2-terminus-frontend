...
function showOrderProducts(data) {
    ...
    h1.innerHTML = `<i class="fa-duotone fa-cart-circle-check" style="margin-right:0.5em;font-size:unset !important;"></i> Order # ${data.orderId} placed on ${data.orderDate}`
    ...
    recap.style.marginBottom = `1em`;
    recap.innerHTML = `<h2>Order Total: $${data.totalPrice}</h2> `

    divSingle.append(recap);
