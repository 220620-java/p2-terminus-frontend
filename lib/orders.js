...
function showOrderProducts(data) {
    ...
    let column1, column2, productImage, cancelBtn, productName, row, products
    column1, column2, cancelBtn, row, products = document.createElement('div')
    ...
    for (r of data.products) {
        ...
        fetchEndpoint(r.endpoint)
            .then((result) => {
                ...
                productName.style.marginBottom = "1em";
                productName.style.borderBottom = "2px dashed #fff";
                ...
                productName.innerHTML = result.title;
