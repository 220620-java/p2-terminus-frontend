            ...
            orders
                ...
                .forEach(order => {
                    ...
                    div.innerHTML = `
                        ...
                        <div onclick="getOrderProducts(${order.orderId}, ${order})" class="xButton" style="display: inline-block;float: right;margin-top: -5.5em;margin-right: 1em;">View Order</div>
                        </div>`;
...
async function getOrderProducts(orderId, order) {
    ...
    for (endpoint of orderObj.products) {
        ...
        let h1 = document.createElement('h1');
        h1.innerHTML = `<i class="fa-duotone fa-cart-shopping-fast" style="margin-right:0.5em"></i> Order # ${order.id} placed on ${order.orderDate}`
