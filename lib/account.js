...
async function putAccountInfo(fnameInp, lnameInp, emailInp) {
    console.log(fnameInp, lnameInp, emailInp)
...
function accountForm(data) {
    ...
    button.addEventListener('click', function() {
        ...
        putAccountInfo(fnameInp.value, lnameInp.value, emailInp.value)
