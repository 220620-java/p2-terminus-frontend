...
async function login() {
    ...
    if (resp.status === 200) {
        ...
        if (loggedInCustomer) {
            ...
            window.location.href = 'http://terminus-front.s3-website-us-east-1.amazonaws.com/index.html#welcome'
            message('info', `Welcome Back, ${loggedInCustomer.firstname} ${loggedInCustomer.lastname}`)
